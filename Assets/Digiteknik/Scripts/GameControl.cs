...
namespace Digiteknik {
	...
	public class GameControl : MonoBehaviour {
		...
		// Tilføjer ekstra levetid ( = health). Ikke i brug endnu
		...
		void Vinder() {
			StartCoroutine(showEnd("Du Vinder!!"));
		}

		void Taber(){
			StartCoroutine(showEnd("Du TABER!"));
		}	
		...
		IEnumerator showEnd(string t){
        	...
        	Debug.Log("Aktive Scene er: " + thisScene.name + ".");
